...
contract Dating is ERC20 {
    ...
    function logIn(string memory _name, string memory _password)
        public
        returns (bool)
    {
        require(!isLoggedIn, "you are already logged In");
    ...
    function sendFriendRequest(string memory _to)
        public
    ...
    function acceptFriendRequest(string memory _friend)
        public
        returns (Notification[] memory)
    {
        require(isLoggedIn, "you are already logged out");
    ...
    function sendMessage(string memory _to, string memory _msg)
        public
    ...
    function handSomeBoy(string memory _name)
        public
    ...
    function sexyGirl(string memory _name)
        public
        returns (uint256, string memory)
    {
